...
interface Window
{
	...
	openDatabase( database:string, ver?:string, desc?:string, size?:number ):void;
	MessageEvent():void;
}

interface Document
{
	getBoxObjectFor( element:any ):any;
}
...
(function( jq )
{
	 ...
	 */
	jq.getCSS = function( url:string ):void
	{
...
jQuery.fn.extend( {
	...
	{
		var pt:string = $( this ).prop( "tagName" );
	 ...
	 */
	alpha: function( value:number ):void
	{
		if( value <= 0
		)
			value = 0;
	 ...
	 * @returns {boolean}
	 */
	visible: function( value ?:boolean ):boolean
	{
	 ...
	 * @param y
	 */
	pos: function( x:number, y:number ):void
	{
		this.css( "left", x );
		this.css( "top", y );
	},
...
function is_bool( obj ):boolean{ return $.type( obj ) == "boolean"; }
function is_string( obj ):boolean{ return $.type( obj ) == "string"; }
function is_number( obj ):boolean{ return $.type( obj ) == "number"; }
function is_array( obj ):boolean{ return $.type( obj ) == "array"; }
function is_function( obj ):boolean{ return $.type( obj ) == "function"; }
function is_date( obj ):boolean{ return $.type( obj ) == "date"; }
function is_regexp( obj ):boolean{ return $.type( obj ) == "regexp"; }
 ...
 * @returns string
 */
function ftime( format:string, ms:number ):string
{
	var ss = 1000;
	var mi = ss * 60;//60000
